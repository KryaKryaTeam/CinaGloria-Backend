...
export class Auto1777485531201 implements MigrationInterface {
    name = 'Auto1777485531201'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "submition_schema" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL, "githubURL" character varying NOT NULL, "youtubeURL" character varying NOT NULL, "assignedToJury" uuid NOT NULL, CONSTRAINT "PK_41dedbad9c2c77330ee7776e490" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "color" character varying NOT NULL, "roundId" uuid, "submitionId" uuid, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."team_status_enum" AS ENUM('IDLE', 'REGISTRATION', 'ACTIVE')`);
        await queryRunner.query(`CREATE TABLE "team" ("id" uuid NOT NULL, "name" character varying NOT NULL, "avatar" character varying NOT NULL, "banner" character varying NOT NULL, "captain" character varying NOT NULL, "status" "public"."team_status_enum" NOT NULL DEFAULT 'IDLE', "history" jsonb NOT NULL DEFAULT '[]', "registrationTimeout" TIMESTAMP, "memberInvites" jsonb NOT NULL DEFAULT '[]', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "activeCompetitionId" uuid, CONSTRAINT "PK_f57d8293406df4af348402e4b74" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "criteria" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "visibility" boolean NOT NULL, "icon" character varying NOT NULL, CONSTRAINT "PK_91cd5f7ff7be5ade9bca5b98cfb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "UserRelTeamMember" ("teamId" uuid NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_5bb3cf180bea888439e6192fbd2" PRIMARY KEY ("teamId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_297e76ce40c1c3ab6295c7b21d" ON "UserRelTeamMember" ("teamId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a17199cebf5300f890be1c39a5" ON "UserRelTeamMember" ("userId") `);
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_29ab54b3d1a52d5cbb36cef0775" FOREIGN KEY ("submitionId") REFERENCES "submition_schema"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_f8105ed25dd2cba1d80aabaa4e6" FOREIGN KEY ("activeCompetitionId") REFERENCES "competition"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "UserRelTeamMember" ADD CONSTRAINT "FK_297e76ce40c1c3ab6295c7b21d1" FOREIGN KEY ("teamId") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "UserRelTeamMember" ADD CONSTRAINT "FK_a17199cebf5300f890be1c39a5b" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "UserRelTeamMember" DROP CONSTRAINT "FK_a17199cebf5300f890be1c39a5b"`);
        await queryRunner.query(`ALTER TABLE "UserRelTeamMember" DROP CONSTRAINT "FK_297e76ce40c1c3ab6295c7b21d1"`);
        ...
        await queryRunner.query(`ALTER TABLE "team" DROP CONSTRAINT "FK_f8105ed25dd2cba1d80aabaa4e6"`);
        await queryRunner.query(`ALTER TABLE "round" DROP CONSTRAINT "FK_1bf0da6dee0bece0ec5e93280ba"`);
        await queryRunner.query(`ALTER TABLE "task" DROP CONSTRAINT "FK_29ab54b3d1a52d5cbb36cef0775"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_a17199cebf5300f890be1c39a5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_297e76ce40c1c3ab6295c7b21d"`);
