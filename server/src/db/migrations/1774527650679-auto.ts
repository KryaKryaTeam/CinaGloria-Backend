...
export class Auto1774527650679 implements MigrationInterface {
    name = 'Auto1774527650679'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "color" character varying, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "competition" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying, "description" text, "ultraWideBanner" character varying, "banner" character varying, "avatar" character varying, "socialMedia" character varying, "dateOfStart" TIMESTAMP WITH TIME ZONE, "dateOfEnd" TIMESTAMP WITH TIME ZONE, "dateOfStartRegistration" TIMESTAMP WITH TIME ZONE, "dateOfEndRegistration" TIMESTAMP WITH TIME ZONE, "publishAt" TIMESTAMP WITH TIME ZONE, "rules" jsonb NOT NULL DEFAULT '[]', "status" "public"."competition_status" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a52a6248db574777b226e9445bc" PRIMARY KEY ("id"))`);
