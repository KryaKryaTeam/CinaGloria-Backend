...
export class MemberAcceptedInviteForCompetitionEvent extends Event<{
  memberId: string;
  team: TeamEntity;
}> {
  public EventType: EventType = EventType.MEMBER_ACCEPT_INVITE_FOR_COMPETITION;
  ...
  load(
    ...
    const ev = new MemberAcceptedInviteForCompetitionEvent(data.payload);
    return ev;
  }
