...
export class Auto1774548093077 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "competition" RENAME COLUMN "publishAt" TO "publishedAt"`,
    );
    await queryRunner.query(
    ...
    try {
      ...
      // Якщо помилка каже, що констрейнт вже є, просто ігноруємо її
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "competition" RENAME COLUMN "publishedAt" TO "publishAt"`,
    );
  }
}
