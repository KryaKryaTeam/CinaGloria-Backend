...
export class TeamRegistartionEndedEvent extends Event<{
  team: TeamEntity;
  competitionId: string;
}> {
  public EventType: EventType = EventType.TEAM_REGISTRATION_ENDED;
  ...
  load(
    ...
    const ev = new TeamRegistartionEndedEvent(data.payload);
    return ev;
  }
